  ...
  return (
    <div ref={containerRef} className="w-full bg-black relative overflow-x-hidden md:cursor-none">
      ...
      <div className="fixed inset-0 z-10 flex flex-col items-center justify-start w-full max-w-full p-4 pt-24 md:p-8 md:pt-32 pointer-events-none h-screen">
        ...
        >
          ...
          <button 
            ...
            className="mt-6 md:mt-8 px-8 py-3 border border-white text-white text-sm tracking-widest hover:bg-white hover:text-black transition-all duration-300 uppercase cursor-pointer bg-transparent mb-8 md:mb-12 pointer-events-auto relative z-50 font-medium"
          >
            Enter
          </button>
        </motion.div>
      ...
      <div className="relative z-20 flex flex-col w-full pointer-events-none">
        ...
        {/* The Content Section */}
        <div className="w-full flex flex-col items-center pb-24 pt-24 pointer-events-auto">
